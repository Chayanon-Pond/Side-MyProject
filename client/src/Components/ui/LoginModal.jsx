        ...
        <div className="text-center">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Learning to read these cues can help you respond to your cat's
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3 px-4 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors font-medium cursor-pointer"
            >
              Create account
            </button>
