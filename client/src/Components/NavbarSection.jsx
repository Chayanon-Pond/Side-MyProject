            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-sm font-medium max-w-24 truncate">{user.full_name || user.fullName || user.name}</span>
                  <svg className={isDropdownOpen ? "w-4 h-4 transition-transform rotate-180" : "w-4 h-4 transition-transform"} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {isDropdownOpen && (
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 z-20">
                      <button onClick={() => { closeDropdown(); navigate('/profile'); }} className="w-full flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        <svg className="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          {/* User icon without arc commands */}
                          <circle cx="12" cy="8" r="4" strokeWidth={2} />
                          <path d="M4 20c0-4 4-7 8-7s8 3 8 7" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        Profile
                      </button>
                      <button onClick={() => { closeDropdown(); navigate('/reset-password'); }} className="w-full flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        <svg className="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          {/* Lock icon without arc commands */}
                      ...
                      {(user.role === 'admin' || user.is_admin) && (
                        <button onClick={() => { closeDropdown(); navigate('/admin'); }} className="w-full flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                          <svg className="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
